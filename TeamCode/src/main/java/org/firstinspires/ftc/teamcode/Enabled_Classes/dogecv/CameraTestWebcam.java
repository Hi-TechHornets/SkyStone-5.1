...
public class CameraTestWebcam extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        skyStoneDetector.addScorer(new RatioScorer(0.4, 3));
        skyStoneDetector.addScorer(new MaxAreaScorer(0.01));
        skyStoneDetector.addScorer(new PerfectAreaScorer(5000, 0.05));
        skyStoneDetector.blackFilter = new GrayscaleFilter(lower, upper);
