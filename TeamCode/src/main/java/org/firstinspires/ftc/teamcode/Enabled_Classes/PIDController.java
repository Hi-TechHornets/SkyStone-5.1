...
public class PIDController
{
    ...
    private double m_tolerance = 0.05;      // the percentage pidError that is considered on target
    ...
    private void calculate()
    {
        ...
        if (m_enabled)
        {
            ...
            // Set the current pidError to the previous pidError for the next cycle.
            m_prevError = m_error;
    ...
    /**
     * Set the percentage pidError which is considered tolerable for use with
     * OnTarget. (Input of 15.0 = 15 percent)
     * @param percent pidError which is tolerable
     */
    ...
    /**
     * Return true if the pidError is within the percentage of the total input range,
     * determined by setTolerance. This assumes that the maximum and minimum input
     * were set using setInputRange.
     * @return true if the pidError is less than the tolerance
     */
    ...
    /**
     * Reset the previous pidError,, the integral term, and disable the controller.
     */
    public void reset()
    {
        disable();
