...
@Config
public class blueFoundationCenter extends LinearOpMode {
...
//        drive.invertMotors();
        ...
        drive.setPoseEstimate(new Pose2d(35, 61, Math.toRadians(180)));
        ...
        Trajectory pullFound = drive.trajectoryBuilder()
                .splineTo(new Pose2d(foundationHeight + 2, 78, Math.toRadians(90)), new ConstantInterpolator(Math.toRadians(180)))
                .build();
